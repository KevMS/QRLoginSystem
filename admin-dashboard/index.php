                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo '<td> ';
                                                echo '<a type="button" class="btn btn-xs btn-success" style="margin-right: 4px;" href="edit.php?id=' . $row['Userid'] . '"> EDIT </a>';
                                                echo '<a type="button" class="btn btn-xs btn-danger" href="../config/delete.php?id=' . $row['Userid'] . '">DELETE </a> </td>';
                                                echo '</tr> ';
                                                $count = $count + 1;
                                            }
                                            ?>
